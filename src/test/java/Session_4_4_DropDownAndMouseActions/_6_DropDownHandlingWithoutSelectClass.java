package Session_4_4_DropDownAndMouseActions;
...
public class _6_DropDownHandlingWithoutSelectClass {
	...
	public void dropDown() throws InterruptedException
	{
		...
		for (int i = 0; i < rightClickMenuOptions.size(); i++) 
		{
			...
			System.out.println("Option No " + (i) +" is "+ rightClickMenuOptions.get(i).getText());
			if (rightClickMenuOptions.get(i).getText().equals("Delete")) 
			{
				Thread.sleep(2000);
